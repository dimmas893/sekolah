        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Nilai semua jenjang sd</div>
                </div>
            </div>
            <div class="section-body">
                ...
                @foreach ($mata_pelajaran as $item)
                    @php
                        $guru = \App\Models\Jadwal::where('jenjang_pendidikan_id', 1)
                    ...
                    <div class="card">
                        ...
                        @foreach ($guru as $gur)
                            @php
                                $kelas = \App\Models\Jadwal::where('jenjang_pendidikan_id', 1)
                                    ->whereHas('kelasget', function ($q) use ($tahun) {
                                        $q->where('id_tahun_ajaran', $tahun);
                                    })
                                    ->where('mata_pelajaran_id', $item->mata_pelajaran_id)
