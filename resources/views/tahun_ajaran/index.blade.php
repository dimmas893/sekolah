    ...
    <div class="main-content">
                            ...
                            <div class="modal-body">
                                <div class="my-2">
                                    ...
                                    <input type="number" name="tahun_ajaran" class="form-control"
                                        placeholder="Masukan Nama Tahun Ajaran" required>
                                </div>
                            </div>
        ...
        <section class="section">
            <div class="section-header">
                <h1>Halaman Data Tahun Ajaran</h1>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel Tahun Ajaran</h3>
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah Tahun Ajaran</button>
                            </div>
                            <div>
