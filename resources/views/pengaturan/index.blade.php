                        ...
                        <div class="modal-body">
                            <div class="my-2">
                                ...
                                <input type="text" name="nama_ujian" class="form-control"
                                    placeholder="Masukan nama_ujian" required>
                            </div>
                            <div class="my-2">
                                <label for="name">Waktu</label>
                                <input type="number" name="waktu" class="form-control" placeholder="Masukan Waktu ujian"
                                    required>
                            </div>
                            <div class="my-2">
                                <label for="name">Nilai Miniman</label>
                                <input type="number" name="nilai_min" class="form-control"
                                    placeholder="Masukan Nilai Minimal" required>
                            </div>
                            <div class="my-2">
                                <label for="name">Peraturan Ujian</label>
                                <textarea name="peraturan_ujian" class="form-control" placeholder="Masukan Peraturan Ujian" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="my-2">
                                ...
                                <input type="number" name="waktu" id="waktu" class="form-control"
                                    placeholder="Masukan Waktu ujian" required>
                            </div>
                            <div class="my-2">
                                <label for="name">Nilai Miniman</label>
                                <input type="number" name="nilai_min" id="nilai_min" class="form-control"
                                    placeholder="Masukan Nilai Minimal" required>
                            </div>
                            <div class="my-2">
                                <label for="name">Peraturan Ujian</label>
                                <textarea name="peraturan_ujian" id="peraturan_ujian" class="form-control" placeholder="Masukan Peraturan Ujian"
                                    required></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
        ...
        $(function() {
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $("#nama_ujian").val(response.nama_ujian);
                        $("#waktu").val(response.waktu);
                        $("#nilai_min").val(response.nilai_min);
                        $("#peraturan_ujian").val(response.peraturan_ujian);
                        $("#id").val(response.id);
                    }
                });
            });
