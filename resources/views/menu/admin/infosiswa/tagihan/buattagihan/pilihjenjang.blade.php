...
@section('content')
    <form method="get" id="siswa_tagihan_tk" action="{{ route('siswa_tagihan') }}" style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="4">
        <input type="submit" class="btn btn-primary" value="Masuk">
    </form>
    <form method="get" id="siswa_tagihan_sd" action="{{ route('siswa_tagihan') }}" style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="1">
        <input type="submit" class="btn btn-primary" value="Masuk">
    </form>
    <form method="get" id="siswa_tagihan_smp" action="{{ route('siswa_tagihan') }}" style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="2">
        <input type="submit" class="btn btn-primary" value="Masuk">
    </form>
    <form method="get" id="siswa_tagihan_sma" action="{{ route('siswa_tagihan') }}" style="display:none;">
        @csrf
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-lg-3">
                        <a href="{{ route('siswa_tagihan') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('siswa_tagihan_tk').submit();">
                            <div class="card">
                                <div class="card-body">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('siswa_tagihan') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('siswa_tagihan_sd').submit();">
                            <div class="card">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('siswa_tagihan') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('siswa_tagihan_smp').submit();">
                            <div class="card">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('siswa_tagihan') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('siswa_tagihan_sma').submit();">
                            <div class="card">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
