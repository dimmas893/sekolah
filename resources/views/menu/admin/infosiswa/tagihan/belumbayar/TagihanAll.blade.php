...
@section('content')
    ...
    <form method="get" id="viewTagihansiswabelumdibayarPilihtagihan_id"
        action="{{ route('viewTagihansiswabelumdibayarPilihtagihan') }}" style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="{{ $jenjang->id }}">
        <input type="hidden" name="kelas_id" value="{{ $kelas }}">
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="{{ route('viewTagihansiswabelumdibayarPilihtagihan') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('viewTagihansiswabelumdibayarPilihtagihan_id').submit();">
                            Pilih Siswa
                        </a></div>
                                        ...
                                        <div class="col-3">
                                            <div class="card shadow card-primary">
                                                <div class="card-header d-flex justify-content-between align-items-center">
                                                    ...
                                                    Rp {{ $item->nominal }}
                                                    {{-- <form action="{{ route('viewTagihansiswabelumdibayarPilihKelas') }}"
                                                        method="get">
                                                        @csrf
