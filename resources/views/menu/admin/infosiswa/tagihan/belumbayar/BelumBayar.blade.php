...
@section('content')
    <form method="get" id="viewTagihansiswabelumdibayarPilihKelas_tk"
    ...
    <form method="get" id="viewTagihansiswabelumdibayarPilihKelas_sd"
        action="{{ route('viewTagihansiswabelumdibayarPilihKelas') }}" style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="1">
        <input type="submit" class="btn btn-primary" value="Masuk">
    </form>
    <form method="get" id="viewTagihansiswabelumdibayarPilihKelas_smp"
        action="{{ route('viewTagihansiswabelumdibayarPilihKelas') }}" style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="2">
        <input type="submit" class="btn btn-primary" value="Masuk">
    </form>
    <form method="get" id="viewTagihansiswabelumdibayarPilihKelas_sma"
        action="{{ route('viewTagihansiswabelumdibayarPilihKelas') }}" style="display:none;">
        @csrf
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-lg-3">
                        <a href="{{ route('viewTagihansiswabelumdibayarPilihKelas') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('viewTagihansiswabelumdibayarPilihKelas_tk').submit();">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('viewTagihansiswabelumdibayarPilihKelas') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('viewTagihansiswabelumdibayarPilihKelas_sd').submit();">
                            <div class="card shadow card-primary">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('viewTagihansiswabelumdibayarPilihKelas') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('viewTagihansiswabelumdibayarPilihKelas_smp').submit();">
                            <div class="card shadow card-primary">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('viewTagihansiswabelumdibayarPilihKelas') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('viewTagihansiswabelumdibayarPilihKelas_sma').submit();">
                            <div class="card shadow card-primary">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
