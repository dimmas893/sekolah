            ...
            <div class="section-body">
                @if ($role === 1)
                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <img class="d-block" width="80px"
                                                                src="/icon/kategoritagihan.png" alt="First slide">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <img class="d-block" width="80px" src="/icon/tagihansiswa.png"
                                                                alt="First slide">
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('searchbayartagihan') }}">
                                <div class="card shadow card-primary">
                                    <div class="card-body">
                                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <img class="d-block" width="80px" src="/icon/bayartagihan.png"
                                                                alt="First slide">
                                                        </div>
                                                    </div>
                                                </div>
