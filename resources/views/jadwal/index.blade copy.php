                        ...
                        <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="my-2">
                                    ...
                                    <select name="" id="isMember" class="form-control">
                                ...
                                <div class="tampil my-2 mt-3" id="SD">
                                    <label for="name">Kelas</label>
                                    <select name="kelas_id" class="form-control">
                                        <option selected disabled>---Pilih kelas---</option>
                                        @foreach ($sd as $item => $value)
                                            {{ $jadwal = \App\Models\Jadwal::where('kelas_id', $value->id)->first() }}
                                            @if ($jadwal == null)
                                                <option value="{{ $value->id }}">{{ $value->kelas->name }}</option>
                                            @endif
                                        @endforeach
                                ...
                                <div class="tampil my-2 mt-3" id="SMP">
                                    <label for="name">Kelas</label>
                                    <select name="kelas_id" class="form-control">
                                        <option selected disabled>---Pilih kelas---</option>
                                        @foreach ($smp as $item => $value)
                                            {{ $jadwal = \App\Models\Jadwal::where('kelas_id', $value->id)->first() }}
                                            @if ($jadwal == null)
                                                <option value="{{ $value->id }}">{{ $value->kelas->name }}</option>
                                            @endif
                                ...
                                <div class="tampil my-2 mt-3" id="SMA">
                                    <label for="name">Kelas</label>
                                    <div id="sma"></div>
                                    </select>
                                </div>
                                ...
                                <div class="tampil my-2 mt-3" id="TK">
                                    <label for="name">Kelas</label>
                                    <div id="sma"></div>
                                </div>
                                <div class="my-2">
                                ...
                                <div class="my-2">
                                    ...
                                    <select name="kelas_id" id="kelas_id" class="form-control">
                                        @foreach ($kelas as $item)
                                            <option value="{{ $item->id }}">{{ $item->kelas->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
