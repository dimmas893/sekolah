    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Halaman Pendaftaran Siswa Jenjang SD</h1>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pendaftaran-store_sd') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="step1">
                                    <div class="row">
                                        ...
                                        <div class="col-6 my-2">
                                            <label for="">Email Bapak</label>
                                            <input type="email" name="email_bapak" placeholder="Masukan email Bapak"
                                                class="form-control" />
                                        </div>
                                        ...
                                        <div class="col-6 my-2">
                                            ...
                                            <input type="email" name="email_ibu" placeholder="Masukan email Ibu"
                                                class="form-control" />
                                        </div>
