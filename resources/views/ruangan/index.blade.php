                    ...
                    <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="my-2">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Masukan Nama Ruangan"
                                    required>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel Ruangan</h3>
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah Ruangan</button>
                            </div>
                            <div>
